...
public class Avaliacao {
	...
	public Avaliacao(long utilizadorId, long sandesId, Nota nota, String comentario) {
	...
	public AvaliacaoDTO transformToDto() {
		return new AvaliacaoDTO(this.getUtilizadorId(), this.getSandesId(),this.getNota().getNota(),this.getComentario());
	}
	public static class Builder {
		...
		public Builder setNota(Nota nota) {
			this.nota = nota;
			return this;
		}
